...
<div class="container py-5">
    <div class="d-between mb-4">
        ...
        <button class="btn-bordered" data-target="#insert-modal" data-toggle="modal">문의하기</button>
    </div>
    <div class="t-head">
...
<form action="/insert/inquires" id="insert-modal" class="modal fade" method="post">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
